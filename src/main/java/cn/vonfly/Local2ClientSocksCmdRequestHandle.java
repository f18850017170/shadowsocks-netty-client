...
public final class Local2ClientSocksCmdRequestHandle extends SimpleChannelInboundHandler<SocksRequest> {
...
//                    ctx.pipeline().addLast(new SocksCmdRequestDecoder());
                    ctx.pipeline().addLast(new Local2RemoteConnectedHandler()); //TODO
